...
\begin{itemize}[leftmargin=*, itemsep=2pt]
\setlength\itemsep{0em}
\item \textbf{Tech Stack}: .NET, C\#, Golang, Java, Spring Boot, React, TypeScript, SQL/NoSQL, Docker
\item \textbf{Cloud \& DevOps}: GCP, AWS, Docker, Git/GitHub, CI/CD, Postman
...
\begin{itemize}[leftmargin=*, itemsep=2pt]
\setlength\itemsep{0em}
\item \tr{Redesign and rebuild of the company's institutional website, with the front-end deployed on Google Cloud Run (GCP).}{Redesign e reconstrução do site institucional da empresa, com front-end implantado no Google Cloud Run (GCP).}
\item \tr{Modern, responsive UI replacing the previous legacy site.}{Interface moderna e responsiva, substituindo o site legado anterior.}
\end{itemize}
...
\entry{\tr{Technologist in Systems Analysis and Development}{Tecnólogo em Análise e Desenvolvimento de Sistemas}}{2025}{[\tr{Institution}{Instituição}]}{Londrina - PR}
