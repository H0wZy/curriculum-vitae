...
\href{mailto:howzysolutions@gmail.com}{\faBriefcase \space howzysolutions@gmail.com} \tr{(business)}{(comercial)} \\
\href{https://www.linkedin.com/in/marcosh0wzy/}{\faLinkedin \space marcosh0wzy} \\
\href{https://github.com/H0wZy}{\faGithub \space H0wZy} \\
\href{https://howzysolutions.com}{\faLink \space howzysolutions.com}
...
\noindent
\tr{%
Software Engineer focused on backend with Java/JSF and .NET/Golang, most recently at TCS on the Copel account. Two-time TCS AI Friday champion for solutions built with LLMs and predictive models. Experienced in modernizing legacy systems to the cloud (GCP/AWS) and building REST APIs with Clean Code, SOLID and testing.%
}{%
...
\entry{Tata Consultancy Services \textbar\ Copel}{\faCalendar \space 05/2025 -- 08/2026}{Software Engineer}{Londrina - PR}
\vspace{-0.4em}
\begin{itemize}[leftmargin=*, itemsep=2pt]
\setlength\itemsep{0em}
\item \tr{Developed and maintained Java 8 / JSF applications on WildFly/JBoss servers.}{Desenvolvi e mantive aplicações Java 8 com JSF em servidores WildFly/JBoss.}
...
\item \tr{Modernized on-premise legacy systems to GCP, with integrations via Denodo.}{Modernizei sistemas legados on-premise para o GCP, com integrações via Denodo.}
\item \tr{Built backend services in Golang.}{Desenvolvi serviços de backend em Golang.}
\item \tr{Worked across cloud environments (GCP and AWS).}{Atuei em ambientes cloud (GCP e AWS).}
\end{itemize}
...
\project{Telas Paraná --- \tr{Institutional Website}{Site Institucional}}{\href{https://frontend-4mxyivrfva-rj.a.run.app/}{\faLink \space \tr{Live}{Produção}} \textbar\ \href{https://telasearamesparana.com.br}{\tr{previous site}{site anterior}}}
\vspace{-0.4em}
\begin{itemize}[leftmargin=*, itemsep=2pt]
\setlength\itemsep{0em}
